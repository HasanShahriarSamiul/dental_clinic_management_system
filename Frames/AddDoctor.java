...
public class AddDoctor extends JFrame implements MouseListener,ActionListener{
	...
	public AddDoctor(RegDoctorList rdl){
		...
		super("ToothCare - Doctor Registration");
		this.setSize(900,600);
		this.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		this.setLocationRelativeTo(null);
		this.rdl = rdl;
	
		color1= new Color(41,171,226);
		...
		userLabel = new JLabel("ToothCare ");
		...
		String items[] = {"DENTAL PATHOLOGY","ORAL & MAXILLOFACIAL SURGARY","PERIODONTICS", "ORTHODONTICS", "COSMETIC DENTISTRY", "ENDODONTICS", "ORAL MEDICINE"};
		...
		img = new ImageIcon("images/dentist.png");
