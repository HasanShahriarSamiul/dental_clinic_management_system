...
public class AddPatient extends JFrame implements MouseListener, ActionListener{
	...
	public AddPatient(PList pl){
		...
		//String dr[] = {"Choose a Doctor", "Dr.Samiul.", "Dr.Asfak", "Dr.Anurag" ,"Dr.Arnab" };
		...
		String rm[] = {"Xray-102 ", "D-201", "D-202", "D-203", "D-204", "D-205","PATH-401", "ICU-402","ICU-403", "CCU-404", "ICCU-501", "ICCU-502", "HDU-503","OT-504"};
		 b2 = new JComboBox(rm);
		...
		img = new ImageIcon("images/add_pt.png");
		imgLabel = new JLabel(img);
		imgLabel.setBounds(465,100,300,300);
		panel.add(imgLabel);
