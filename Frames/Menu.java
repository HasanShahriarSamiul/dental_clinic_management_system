...
public class Menu extends JFrame implements MouseListener,ActionListener{
	...
	public Menu(){
		...
		color2 = new Color(65,119,100);//(65,119,100);
		...
		nameLabel = new JLabel("ToothCare");
		...
		titleLabel = new JLabel("“Healthy Smile, Happy Life”");
		titleLabel.setBounds(330,460,400,40);
		titleLabel.setFont(font2);
		panel.add(titleLabel);
		panel.add(titleLabel);
		
		userLabel = new JLabel("Welcome to your dashboard, Admin");
		userLabel.setBounds(900,90,140,40);
		panel.add(userLabel);
